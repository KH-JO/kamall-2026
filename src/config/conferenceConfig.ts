...
export const conferenceConfig = {
  ...
  welcomeMessage: {
    ...
    paragraphs: [
      ...
      "청명한 가을 하늘과 오곡백과가 무르익는 결실의 계절 10월을 맞이하여, 회원 여러분의 가정에 늘 건강과 행복이 가득하기를 기원합니다.",
  ...
  chairWelcomeMessage: {
    ...
    paragraphs: [
      "존경하는 한국멀티미디어언어교육학회 회원 여러분, 반갑습니다. 2026 KAMALL 연례학술대회장을 맡은 이혜진입니다. 풍요로운 결실의 계절, 이곳 건국대학교 글로컬캠퍼스에서 여러분을 모시고 뜻깊은 학술대회를 개최하게 되어 매우 기쁘게 생각합니다.",
      "바쁘신 일정에도 귀한 걸음 해주시어 오늘 이 자리를 함께 빛내주신 모든 분께 진심으로 감사와 환영의 말씀을 드립니다. 특히 소중한 연구 성과와 교육 현장의 경험을 나누어주실 발표자와 토론자 여러분께 깊이 감사드리며, 이번 학술대회가 성공적으로 개최될 수 있도록 마음과 뜻을 함께해 주신 회원 여러분과 참가자 여러분께도 따뜻한 환영과 감사의 인사를 전합니다.",
      "올해 학술대회의 주제는 'AI for All: Establishing Practical AI Infrastructure for Inclusive Language Learning'입니다. 인공지능이 우리의 일상뿐만 아니라 언어를 가르치고 배우는 방식까지 빠르게 변화시키고 있는 지금, 우리의 관심은 단순히 ‘AI를 어떻게 활용할 것인가’를 넘어 ‘누구나 AI의 혜택을 누릴 수 있는 언어교육을 어떻게 만들어갈 것인가’로 나아가야 할 때라고 생각합니다. 오늘 이 자리에서 나누는 연구와 교육적 실천이 보다 포용적인 언어교육의 미래를 함께 그려보는 의미 있는 출발점이 되기를 바랍니다.",
      "그리고 오늘의 학술대회가 있기까지 보이지 않는 곳에서 오랜 시간 마음과 정성을 모아주신 준비위원회 한 분 한 분께도 특별히 감사의 말씀을 드리고 싶습니다.",
      "먼저 학술대회 준비의 처음부터 마지막까지 큰 방향을 잡아주시고 든든하게 이끌어주신 KAMALL 신동광 회장님께 깊이 감사드립니다. 그리고 수많은 연락과 조율, 크고 작은 실무를 도맡아 학술대회 준비의 중심을 든든히 지켜주신 임관혁 총무이사님께 특별한 감사의 마음을 전합니다. 알찬 학술 프로그램을 위해 세심하게 애써주신 프로그램 체어 임재현 교수님, 소중한 연구 성과가 잘 담길 수 있도록 프로시딩즈를 맡아주신 황요한 교수님, 그리고 준비 과정의 모든 순간마다 함께 고민하고 세심하게 기획하고 조정해주신 이송은 교수님, 이가영 교수님, 권은비 교수님께도 마음 깊이 감사드립니다. 개최지에서 장소와 현장 운영을 위해 수고해주신 이효신 교수님, 국제협력을 위해 힘써주신 강주훈 교수님께도 진심으로 감사드립니다. 학술대회의 살림을 꼼꼼하게 챙겨주신 안유영 교수님과 이은진 교수님, 참가자들을 따뜻하게 맞이할 다과를 준비해주신 김미숙 교수님, 학술대회가 더욱 풍성해질 수 있도록 후원을 위해 많이 애써주신 백지운 교수님, 그리고 학술대회의 얼굴인 홈페이지를 정말 멋지게 만들어주신 조규희 교수님께도 깊이 감사드립니다.",
      "오늘 하루 새로운 지식과 생각을 나누는 것을 넘어, 반가운 얼굴들과 따뜻한 인사를 나누고 새로운 인연을 맺는 시간이 되기를 바랍니다. 또한 오늘 우리가 함께 나누는 질문과 아이디어들이 앞으로의 언어교육을 조금 더 따뜻하고 포용적으로 변화시키는 소중한 씨앗이 되기를 기대합니다.",
      "다시 한번 귀한 걸음 해주신 모든 분을 진심으로 환영하며, 2026 KAMALL 연례학술대회의 성공적인 개최를 위해 함께해주신 모든 분께 깊이 감사드립니다.",
      "감사합니다.",
    ],
  },
